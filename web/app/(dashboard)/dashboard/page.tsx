  ...
  if (isLoading) return (
    <div className="space-y-8">
      <div>
        ...
        <div className="h-4 w-64 shimmer rounded-2xl"></div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 h-80 shimmer rounded-2xl"></div>
        <div className="lg:col-span-2 h-80 shimmer rounded-2xl"></div>
      </div>
    </div>
  );

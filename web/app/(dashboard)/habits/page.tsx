  ...
  if (isLoading) return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex items-start justify-between p-5 bg-white dark:bg-dark-800 border border-gray-100 dark:border-white/5 rounded-2xl shadow-sm dark:shadow-none">
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-dark-900 dark:text-white">Hábitos diarios</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {habits.map((habit) => (
          <div
            key={habit.id}
            className={`group bg-white dark:bg-dark-800 border rounded-2xl p-5 transition-all duration-300 shadow-sm dark:shadow-none ${
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-4 flex-1 min-w-0">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl flex-shrink-0 ${
                  habit.completedToday ? "bg-lime-400/10" : "bg-gray-50 dark:bg-dark-700"
                }`}>
                  {habit.icon}
                </div>
                <div className="min-w-0">
                  <h3 className="font-semibold text-dark-900 dark:text-white">{habit.name}</h3>
              ...
              <div className="flex items-center gap-2">
                <div className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 sm:gap-2 mr-2">
                  <button
                    ...
                    className="p-2 rounded-xl bg-gray-50 dark:bg-dark-700 hover:bg-lime-500/10 text-gray-400 hover:text-lime-400 transition-colors"
                    title="Editar hábito"
                  >
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl bg-gray-50 dark:bg-dark-700 hover:bg-red-500/10 text-gray-400 hover:text-red-400 transition-colors"
                ...
                <button
                  ...
                  className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 ${
                    habit.completedToday
                      ...
                      : "bg-gray-100 dark:bg-dark-600 text-gray-400 dark:text-gray-500 hover:bg-gray-200 dark:hover:bg-dark-500 hover:text-dark-900 dark:hover:text-white"
                  }`}
                >
                ...
                <div key={i} className="flex flex-col items-center gap-1">
                  <div
                    className={`w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-bold transition-all ${
                        ...
                        : "bg-gray-50 dark:bg-dark-700 text-gray-400 dark:text-gray-600"
                    }`}
                  >
                    {dayLabels[i]}
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-dark-800 border border-gray-100 dark:border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form onSubmit={handleCreateHabit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1.5">Nombre del hábito</label>
                <input
                  type="text"
                  value={newHabitName}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1.5">Icono (Emoji)</label>
                <input
                  type="text"
                  value={newHabitIcon}
          ...
          <div className="bg-white dark:bg-dark-800 border border-gray-100 dark:border-white/10 rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2 rounded-xl text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors border border-gray-200 dark:border-white/10"
              >
                Cancelar
              </button>
              <button
